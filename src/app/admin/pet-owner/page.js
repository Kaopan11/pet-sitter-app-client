  ...
  return (
    <div className="w-full max-w-6xl mx-auto flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <h1 className="text-xl font-bold text-gray-900">Pet Owner</h1>
        <div className="relative w-full sm:w-64">
          <input
            ...
            className="w-full pl-4 pr-10 py-2 border border-gray-200 rounded-lg text-sm bg-white focus:outline-none focus:border-orange-500 placeholder-gray-400 text-gray-700 shadow-xs"
          />
          <svg
      ...
      <div className="flex items-center justify-center gap-3 text-sm font-semibold pt-2">
        <button className="w-9 h-9 flex items-center justify-center text-gray-300 hover:text-gray-700 transition-colors cursor-pointer">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M15 19l-7-7 7-7" />
          </svg>
        </button>
        <button className="w-9 h-9 rounded-full bg-orange-100 text-orange-500 font-bold flex items-center justify-center cursor-pointer">
          1
        </button>
        <button className="w-9 h-9 rounded-full bg-white text-gray-400 hover:bg-gray-50 font-semibold flex items-center justify-center cursor-pointer shadow-2xs">
          2
        </button>
